...
type CalculatorRespponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *CalculatorRespponse) Reset() {
	*x = CalculatorRespponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *CalculatorRespponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CalculatorRespponse) ProtoMessage() {}

func (x *CalculatorRespponse) ProtoReflect() protoreflect.Message {
	mi := &file_calculator_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CalculatorRespponse.ProtoReflect.Descriptor instead.
func (*CalculatorRespponse) Descriptor() ([]byte, []int) {
	return file_calculator_proto_rawDescGZIP(), []int{1}
}

func (x *CalculatorRespponse) GetResult() string {
	if x != nil {
		return x.Result
	}
	return ""
...
var file_calculator_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x22, 0x3b, 0x0a, 0x11, 0x43, 0x61, 0x6c, 0x63, 0x75, 0x6c, 0x61, 0x74, 0x6f, 0x72,
	...
	,
...
var file_calculator_proto_goTypes = []any{
	...
	(*CalculatorRespponse)(nil), // 1: CalculatorRespponse
}
var file_calculator_proto_depIdxs = []int32{
	0, // 0: CalculatorService.Greet:input_type -> CalculatorRequest
	1, // 1: CalculatorService.Greet:output_type -> CalculatorRespponse
...
func file_calculator_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_calculator_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*CalculatorRespponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
