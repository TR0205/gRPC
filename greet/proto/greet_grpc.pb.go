...
const (
	...
	GreetService_GreetEveryone_FullMethodName  = "/GreetService/GreetEveryone"
)
...
type GreetServiceClient interface {
	...
	GreetEveryone(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[GreetRequest, GreetRespponse], error)
}
...
func (c *greetServiceClient) Greet(ctx context.Context, in *GreetRequest, opts ...grpc.CallOption) (*GreetRespponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GreetRespponse)
...
func (c *greetServiceClient) GreetManyTimes(ctx context.Context, in *GreetRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[GreetRespponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *greetServiceClient) GreetEveryone(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[GreetRequest, GreetRespponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type GreetService_GreetEveryoneClient = grpc.BidiStreamingClient[GreetRequest, GreetRespponse]
...
type GreetServiceServer interface {
	...
	GreetEveryone(grpc.BidiStreamingServer[GreetRequest, GreetRespponse]) error
...
func (UnimplementedGreetServiceServer) Greet(context.Context, *GreetRequest) (*GreetRespponse, error) {
...
func (UnimplementedGreetServiceServer) GreetEveryone(grpc.BidiStreamingServer[GreetRequest, GreetRespponse]) error {
...
func _GreetService_GreetManyTimes_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(GreetServiceServer).GreetManyTimes(m, &grpc.GenericServerStream[GreetRequest, GreetRespponse]{ServerStream: stream})
}
...
func _GreetService_GreetEveryone_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(GreetServiceServer).GreetEveryone(&grpc.GenericServerStream[GreetRequest, GreetRespponse]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type GreetService_GreetEveryoneServer = grpc.BidiStreamingServer[GreetRequest, GreetRespponse]
